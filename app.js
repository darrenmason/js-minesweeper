document.addEventListener("DOMContentLoaded", () => {
  ...
  function checkSquare(square) {
    ...
    setTimeout(() => {
      if (square.id > 0 && !isLeftEdge(square.id)) {
        click(document.getElementById(squares[currentId - 1].id));
      }
      if (square.id > 9 && !isRightEdge(square.id)) {
        click(document.getElementById(squares[currentId + 1 - width].id));
      }
      if (square.id > 10) {
        click(document.getElementById(squares[currentId - width].id));
      }
  ...
  function gameOver() {
    result.innerHTML =
      "You have been horrendously disfigured by a hidden bomb. Game Over!";
    isGameOver = true;
  ...
  function gameWon() {
    result.innerHTML =
      "You have overcome the darkness. Congratulations. You get a fish. &#128031;";
    isGameOver = true;
  }
});
